...
{
    [AdminCommand]
    [CommandHelper("Promotes the User with the given Id into a higher role.")]
    [CommandExample("Promote|1")]
    public class PromoteCommand : ICommand
    {
        private const string NoSuchUserMessage = "There is no User with the given Id.";

        private const string SuccessPromoteMessage = "Successfully Promoted User - {0}";
