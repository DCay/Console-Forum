...
public class RegisterCommand implements Command {
    private static final String SuccessRegisterMessage = "Successfully registed User - %s!";

    private static final String PasswordsDoNotMatchMessage = "Passwords do not match.";

    private static final String ExistentUsernameMessage = "Username already exists in the database.";
